...
namespace uberConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do{
                Console.WriteLine("\nEntrar como Motorista(m) / Passageiro (p)");
                ...
                switch (resposta){
                    ...
                    case "m":
                            ...
                            string respMenuDois;
                            do{
                                Console.WriteLine("O que deseja fazer agora: Procurar Viagem(p) / Sair (s)");
                                            ...
                                            case "n":
                                                ...
                                                if(respPass == "s"){
                                                    ...
                                                    if(respfim == "s"){
                                                        ...
                                                        pessoa.Delay();
                                                        Console.WriteLine(piloto.receberPagamento());
                                                        Console.WriteLine("\nObrigado por usar o uber generico!\nAperte ENTER para sair do programa.");
                                                        Console.Read();
                                                    }
                                                }
                                            break;
                                ...
                                if(user.TokenLogin != "" && user.TokenLogin != null){
                                    ...
                                    if(psresp == "m"){
                                        ...
                                        if(viagemResp == "y"){
                                            ...
                                            Console.WriteLine("vai sim, sequestro!!!");
                                            pessoa.Delay();
                                        }
                                        //fim if
                                        Console.WriteLine("\nVocê já chegou? s/n");
                                        ...
                                        //inicio analise 
                                         if(finalViagem == "s"){
                                             ...
                                             Console.WriteLine("Valor da viagem: $ 7 = R$100.000.000,00");
                                             Console.WriteLine("--------------------");
